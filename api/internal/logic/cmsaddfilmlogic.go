...
type CmsaddFilmLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewCmsaddFilmLogic(ctx context.Context, svcCtx *svc.ServiceContext) CmsaddFilmLogic {
	return CmsaddFilmLogic{
...
func (l *CmsaddFilmLogic) CmsaddFilm(req types.AddFilmReq) (*types.AddFilmRsp, error) {
